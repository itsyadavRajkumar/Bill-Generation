...
@media only screen and (max-width: 600px) {
  ...
  invoice-link {
    ...
    <body>
      ...
      <div class"footer">
          <a href="https://localhose:5000">
          <img class="footer-logo" src="https://i.postimg.cc/nckgkm5r/LOG.jpg"/>
        </a>
      </div>
    <p style="text-align: center">Make Beautiful Invoice at Bill-generation</p>
    </div>
    </body>
</html>`
;
