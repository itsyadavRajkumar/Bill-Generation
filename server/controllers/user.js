        ...
        .then(user=>{
            ...
            user.save().then((result)=>{
                transporter.sendMail({
                    to:user.email,
                    from:"Bill-Generation <noreply@billgeneration.com>",
                    subject:"Password reset request",
                    html:`
                    <p>You requested for password reset from Bill-Generation application</p>
                    <h5>Please click this <a href="https://localhost:3000/${token}">link</a> to reset your password</h5>
